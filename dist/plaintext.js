...
export async function renderPlainTextEmail(messageTemplateMarkdown, context, options = {}) {
    ...
    const plainTextMessageFragment = await plainTextMarkedInstance.parse(messageMarkdown);
